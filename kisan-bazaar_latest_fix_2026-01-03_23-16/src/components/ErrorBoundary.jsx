        ...
        if (this.state.hasError) {
            ...
            return (
                <div style={{
                    ...
                    {/* Hard Reset Option for critical failures */}
                    <div style={{ marginTop: '2rem' }}>
                        <p style={{ fontSize: '0.8rem', color: '#888', marginBottom: '0.5rem' }}>
                            Still stuck? (अभी भी समस्या है?)
                        </p>
                        <button
                            onClick={() => {
                                if (window.confirm('This will clear all app data and reset completely. Continue? (यह ऐप का सारा डेटा मिटा देगा। जारी रखें?)')) {
                                    localStorage.clear();
