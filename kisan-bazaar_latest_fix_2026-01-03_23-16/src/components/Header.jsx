        ...
        <header style={{
            ...
            <div className="container" style={{
                ...
                <div className="header-search" style={{
                    ...
                    <div style={{
                        ...
                        {/* Voice Search Mic - Moved to Left */}
                        <button
                            onClick={() => {
                            ...
                            style={{
                                ...
                                borderRight: '1px solid #e2e8f0' // Separator
                            }}
                            title="Voice Search"
            ...
            <div className={`container ${isMobileMenuOpen ? 'mobile-nav-open' : 'desktop-nav'}`} style={{ padding: '0.8rem 1rem' }}>
                <nav style={{
                    ...
                    {/* FPO / Institutional */}
                    <Link to="/fpo-registration" onClick={closeMenu} className="nav-link" style={{
                        ...
                        <span className="nav-label-en">FPO / Institutional</span>
                        <span className="nav-label-hi">(संस्थागत)</span>
                    </Link>
