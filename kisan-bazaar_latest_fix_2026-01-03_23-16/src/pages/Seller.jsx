...
const Seller = () => {
    ...
    const handlePreSubmit = (e) => {
        ...
        // Optional: Validate Tehsil if needed, but not strictly required by logic unless business rule changes
        // if (!formData.tehsil) {
        //     alert('Please select a Tehsil/Taluka (कृपया तहसील चुनें)');
        //     return;
        // }
                    ...
                    <form onSubmit={handlePreSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
                        ...
                        <div>
                            ...
                            <PriceAdvisor
                                ...
                                enteredPrice={formData.targetPrice}
                            />
                        </div>
                        ...
                        <div>
                            <label style={{ display: 'block', marginBottom: '8px', fontWeight: '500', color: '#333', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                                Location (स्थान) <span style={{ color: 'red' }}>*</span>
                            </label>
                            <LocationSelector
